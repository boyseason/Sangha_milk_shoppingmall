   ...
   <div id="container">
      <div id="contents">
         ...
         <c:if test="${sessionScope.customerID !=null}">
            <button value="로그아웃" class="inputButton" style="width:200px; font-size:24px; text-align: center;"
               onclick="window.location='logout.do'">로그아웃</button>
         </c:if>
         <c:if test="${sessionScope.customerID == null}">
            <button value="로그인" class="inputButton" style="width:200px; font-size:24px; text-align: center;"
